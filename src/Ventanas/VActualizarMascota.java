 ...
 * @author karen
 */
public class VActualizarMascota extends javax.swing.JFrame {
    private VMascotas v;
     ...
     */
    public VActualizarMascota(VMascotas v, CTiposMascotas cTipoMascotas, CRazas cRazas, MPersonas cliente, CMascotas cMascotas, String nombre) {
        initComponents();
        this.v = v;
        ...
        txtNombreMascota.setText(nombre);
        
        mascota = cMascotas.buscarMascota(cliente, nombre);
    }
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        mascota.setMasc_nombre(txtNombreMascota.getText());
        mascota.setMascota(raza);
        System.out.println(raza.getRaza_id());
        cMascotas.actualizarMascota(cliente, mascota);
